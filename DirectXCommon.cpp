...
Microsoft::WRL::ComPtr<ID3D12Resource> DirectXCommon::CreateDepthStencialTextureResource(Microsoft::WRL::ComPtr<ID3D12Device> device, int32_t width, int32_t height)
{
